	...
	<body>
		<div class="" id="situation">
			...
			<div class="bk-herder relative header-section">
				<div class="bk-herder-logo">ZOOM客房后台管理系统</div>
...
<script>
	var data = [{
		...
		},
		{
			...
			pid: 1,
			icon: '',
			url: 'adminRoomTypeAction_findAll',
			name: '类型管理',
		...
		},
		{
			...
			pid: 1,
			icon: '',
			url: 'adminRoomAction_findAllRoom',
			name: '查看客房',
		...
		},
{
			...
			pid: 3,
			icon: '',
			url: 'adminOrderAction_findAllNoPay',
			name: '未付款订单'
		...
		},
{
			...
			pid: 3,
			icon: '',
			url: 'adminOrderAction_findAllOver',
			name: '已完成订单'
		...
		},
{
			...
			pid: 3,
			icon: '',
			url: 'adminOrderAction_findAllDoing',
			name: '进行中订单',
		...
		},
		{
			...
			pid:4,
			icon: '',
			url: "adminMemberAction_findAll1",
			name: '积分型会员',
		...
		,
		{
			...
			pid:4,
			icon: '',
			url: "adminMemberAction_findAll2",
			name: '储值型会员',
