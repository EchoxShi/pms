								...
								<!--<div class="Shops_info clearfix">-->
									<!--<div class="left_shop">-->
										...
										<!--<div class="Shops_content">-->
											...
											<!--</ul>-->
										<!--</div>-->
										<!--&lt;!&ndash;<div class="right_shop">&ndash;&gt;-->
											<!--&lt;!&ndash;<p> 店铺动态评分：</p>&ndash;&gt;-->
											<!--&lt;!&ndash;<ul>&ndash;&gt;-->
												<!--&lt;!&ndash;<li><label class="name">相符描述</label><span class="score">4.5分</span></li>&ndash;&gt;-->
												<!--&lt;!&ndash;<li><label class="name">服务态度</label><span class="score">4.0分</span></li>&ndash;&gt;-->
												<!--&lt;!&ndash;<li><label class="name">发货速度</label><span class="score">4.6分</span></li>&ndash;&gt;-->
											<!--&lt;!&ndash;</ul>&ndash;&gt;-->
										<!--&lt;!&ndash;</div>&ndash;&gt;-->
									<!--</div>-->
