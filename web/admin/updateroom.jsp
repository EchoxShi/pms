...
<div class="pages-style" >
	...
	<div class="bk-con-message message-section" id="iframe_box">
           ...
           <!--添加客房-->
          <s:form action="adminRoomAction_update" method="POST" enctype="multipart/form-data">
			  <table style="line-height: 15mm" >
				  <tr>
				  ...
				  <tr>
					  <td>房间号：</td>
					  <td><s:textfield name="roomNum" value="%{roomNum}" cssClass="t"></s:textfield></td>
				  </tr>
				  <tr>
					  <td>房间名：</td>
					  <td><s:textfield name="roomName" value="%{roomName}" cssClass="t"></s:textfield></td>
				  </tr>
				  <tr>
					  <td>房间类型：</td>
				  ...
				  <tr>
					  <td>说明：</td>
					  <td><s:textarea name="remark" value="%{remark}" cssClass="t"></s:textarea></td>
				  </tr>
				  <tr>
					  <td>价格（元/晚）:</td>
					  <td class="t"><s:textfield name="pricePerNight"  value="%{pricePerNight}" cssClass="t"></s:textfield></td>
				  </tr>
				  <tr>
					  <td colspan="2" align="center"><s:submit  value="修改"></s:submit></td>
				  </tr>
			  </table>
		  </s:form>
			</div>
